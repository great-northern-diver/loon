...
# from .loon_class import loon, loon_l_compound, loon_l_savedStates
# @singledispatch
# def l_copyStates(source, target,
#                 states = None,
#                 exclude = None,
#                 excludeBasicStates = True,
#                 returnNames = False):
#     exit('unsupported type of ', type(source))



# @l_copyStates.register
# def _(source: loon_l_savedStates, target,
#         states = None,
#         exclude = None,
#         excludeBasicStates = True,
#         returnNames = False):
#     if source.type is type(target):
#         if(isinstance(target, loon_l_compound)):
#             def copyforeach(i):

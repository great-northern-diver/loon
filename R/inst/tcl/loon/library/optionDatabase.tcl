...
#			     \#CCEBC5 \#FFED6F]
    ...
    set Options(colors) [list "gray10" "#1F78B4" "#E31A1C" "#33A02C" "#FF7F00" "#FFFF00" "#6A3D9A" "#B15928" "#8B864E" "gray40" "white" "gray60" "#A6CEE3" "#FB9A99" "#B2DF8A" "#FDBF6F" "#FFFF99" "#CAB2D6" "#DEB887" "#CDC673" "lightgrey"]
	...
	switch -- [string tolower $type] {
	    loon {
		set Options(colors) [list "gray10" "gray40" "#E31A1C" "#FF7F00" "#FFFF00" "#33A02C" "#1F78B4" "#6A3D9A" "#B15928" "#8B864E" "white" "lightgrey" "gray60" "#FB9A99" "#FDBF6F" "#FFFF99" "#B2DF8A" "#A6CEE3" "#CAB2D6" "#DEB887" "#CDC673"]

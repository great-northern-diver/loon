...
# Pack the group and move the group layer up  FAIL (one of these was placed at the beginning rather than the end of the list of layers!!!)
l_layer_demote(p_map, other.boundary.lakes.islands.layer)
l_layer_demote(p_map, other.boundary.lakes.layer)
...
# Pack the group and move the group layer up  FAIL (one of these was placed at the beginning rather than the end of the list of layers!!!)
l_layer_demote(p_map, interior.lakes.islands.layer)
l_layer_demote(p_map, interior.lakes.layer)

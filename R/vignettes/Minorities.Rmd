...
Clearly, Toronto dominates in size, followed by Vancouver at the far left, and Montreal to the near right.  The points could also be moved (temporarily)
to a grid.
...
Could just take them in order first, then do PairViz ordering.

```{r PairViz, eval=FALSE}

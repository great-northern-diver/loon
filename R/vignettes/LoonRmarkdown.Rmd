...
```{r gp png loon, message = FALSE, warning = FALSE, error = FALSE}
...
```{r knitr png, out.width = "60%", fig.align = "center", fig.width = 6, fig.height = 5}
knitr::include_graphics(path = "./images/loonplot1.png")
```

which looks slightly different because of the transfer of the grid graphic to "png"
...
```{r save many pngs, echo=TRUE, message = FALSE, warning = FALSE, error = FALSE}
...
```{r knitr several,  eval = TRUE, out.width = "60%", fig.align = "center", fig.width = 6, fig.height = 5, fig.show = "hold"}
knitr::include_graphics(path = "./images/loonplot1.png")
...
```{r grid raster funs and png package, message = FALSE, warning = FALSE, error = FALSE, out.width = "100%", fig.align = "center", fig.width = 12, fig.height = 10}
library(grid)
library(gridExtra)
library(png)

...
This is done using the function `l_saveStates()`.
...
```{r l_saveStates, eval = TRUE, message = FALSE, warning = FALSE, error = FALSE}
...
# (excludes certain "basic" states, see help(l_saveStates))
l_saveStates(p, file = myFileName)
...
```{r l_getSavedStates, eval = TRUE, message = FALSE, warning = FALSE, error = FALSE}
...
# And read the saved data back in using l_getSavedStates()

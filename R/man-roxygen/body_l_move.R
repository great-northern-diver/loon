#' @description Scatterplot and graph displays support interactive temporary 
#'   relocation of single points (nodes for graphs).
#'   
#' @param widget plot or graph widget handle or widget path name
#' @param which either one of \code{'selected'}, \code{'active'}, \code{'all'}, 
#'   or a boolean vector with a value for each point.
#'   
#' @details Moving the points temporarily saves the new point coordinates to the
...
#'   
#' @seealso \code{\link{l_move_valign}}, \code{\link{l_move_halign}},
